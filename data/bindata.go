...
func cloudsJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "clouds.json", size: 1389, mode: os.FileMode(420), modTime: time.Unix(1628922159, 0)}
...
func customersJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "customers.json", size: 1667, mode: os.FileMode(420), modTime: time.Unix(1628922159, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func pressJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "press.json", size: 2030, mode: os.FileMode(420), modTime: time.Unix(1628922159, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func testimonialsJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "testimonials.json", size: 3401, mode: os.FileMode(420), modTime: time.Unix(1628922159, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
