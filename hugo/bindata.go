...
func configJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "config.json", size: 649, mode: os.FileMode(420), modTime: time.Unix(1629095047, 0)}
...
func paramsDevJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "params.dev.json", size: 942, mode: os.FileMode(420), modTime: time.Unix(1629095047, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func paramsJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "params.json", size: 843, mode: os.FileMode(420), modTime: time.Unix(1629095047, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
