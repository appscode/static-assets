...
func configJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "config.json", size: 642, mode: os.FileMode(420), modTime: time.Unix(1568100601, 0)}
...
func paramsDevJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "params.dev.json", size: 942, mode: os.FileMode(420), modTime: time.Unix(1593072351, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func paramsJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "params.json", size: 840, mode: os.FileMode(420), modTime: time.Unix(1593072294, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
